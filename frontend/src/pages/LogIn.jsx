...
// //   const {serverUrl,userData,setUserData,setLoading} = useContext(userDataContext);
...
// //                        flex flex-col gap-4
// //                        shadow-lg min-h-fit md:min-h-[600px] md:justify-center"  onSubmit={handleSignin}
...
// //         <p className="text-white text-4.5 cursor-pointer  text-center" onClick={()=>navigate("/signup")}>Want to Create New Account ? <span className="text-blue-500">Register</span> </p>
// //       </form>
// //     </div>
// //   );
// // }
...
//       setUserData(data);
//       navigate("/"); // or navigate("/", { replace: true });
//     } catch (error) {
//       console.error("Error during login:", error);
...
//       >
//         {/* avoid fixed heights; let content define height if you want more flexibility */}
